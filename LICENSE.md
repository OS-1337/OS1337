...
- For the underlying software please see [LICENSES.md](docu/internal/LICENSES.md) .
...
### [Licenses for underlying packages & software can be found in /docu/LICENSES.md](docu/internal/LICENSES.md).
...
- As done so by us and documented in our [LICENSES.md file](docu/internal/LICENSES.md).
